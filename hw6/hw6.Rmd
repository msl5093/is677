...
From the above graphs and plots, we can see that both models do an acceptable job of predicting the price. Neither is perfect or particularly outstanding.

Looking at the confidence intervals for each model, it appears that carat, cut, and clarity are the most strongly correlated with the dependent variable, price. Most of the other variables are of little or no strong correlation, which could be why some of our plots indicate wider distributions of the pedicted versus actual values.
